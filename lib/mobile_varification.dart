...
class mobilevarification extends StatefulWidget {
  mobilevarification({Key? key}) : super(key: key);

  @override
  State<mobilevarification> createState() => _mobilevarificationState();
}

class _mobilevarificationState extends State<mobilevarification> {
  @override
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: ((context) => account_created())));
                    },
                    // account_created
                    child: Text(
                      'Submit',
